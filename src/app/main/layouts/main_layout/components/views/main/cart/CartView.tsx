                                ...
                                <div className="m-4">
                                        ...
                                        <div className="col-lg-5">
                                            <div className="me-lg-5">
                                                <div className="d-flex">
                                                    <img src="assets/images/11.webp" className="border rounded me-3"
                                    ...
                                    <div className="row gy-3 mb-4">
                                        <div className="col-lg-5">
                                            <div className="me-lg-5">
                                                <div className="d-flex">
                                                    <img src="assets/images/12.webp" className="border rounded me-3"
                                                         style={ { width: "96px", height: "96px" } }/>
                                                    <div className="">
                                    ...
                                    <div className="row gy-3">
                                        <div className="col-lg-5">
                                            <div className="me-lg-5">
                                                <div className="d-flex">
                                                    <img src="assets/images/10.webp" className="border rounded me-3"
                                                         style={ { width: "96px", height: "96px" } }/>
                                                    <div className="">
                                                        <a href="#" className="nav-link">T-shirt for Men</a>
                                                        <p className="text-muted">XL size</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card px-4 border shadow-0 mb-4 mb-lg-0">
                                ...
                                <a href="#" className="">
                                    <img src="assets/images/7.webp" className="card-img-top rounded-2"/>
                                </a>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card px-4 border shadow-0 mb-4 mb-lg-0">
                                ...
                                <a href="#" className="">
                                    <img src="assets/images/5.webp" className="card-img-top rounded-2"/>
                                </a>
                                <div className="card-body d-flex flex-column pt-3 border-top">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card px-4 border shadow-0">
                                ...
                                <a href="#" className="">
                                    <img src="assets/images/9.webp" className="card-img-top rounded-2"/>
                                </a>
                                <div className="card-body d-flex flex-column pt-3 border-top">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="card px-4 border shadow-0">
                                ...
                                <a href="#" className="">
                                    <img src="assets/images/10.webp" className="card-img-top rounded-2"/>
                                </a>
                                <div className="card-body d-flex flex-column pt-3 border-top">
